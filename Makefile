...
pkgdatadir = $(datadir)/vsptk
pkgincludedir = $(includedir)/vsptk
pkglibdir = $(libdir)/vsptk
pkglibexecdir = $(libexecdir)/vsptk
...
OBJEXT = o
PACKAGE = vsptk
PACKAGE_BUGREPORT = eetorres@gmail.com
PACKAGE_NAME = vsptk
PACKAGE_STRING = vsptk 1.0
PACKAGE_TARNAME = vsptk
PACKAGE_URL = 
PACKAGE_VERSION = 1.0
PATH_SEPARATOR = :
SET_MAKE = 
